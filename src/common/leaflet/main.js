...
$(function () {
    ...
    map.on(L.Draw.Event.CREATED, function (event) {
        ...
        coordinate = [layer._latlngs[0][0].lat, layer._latlngs[0][0].lng, layer._latlngs[0][2].lat, layer._latlngs[0][2].lng];
        console.log(coordinate);
        data = '[out:json];(node(' + coordinate + ')["building"];way(' + coordinate + ')["building"];relation(' + coordinate + ')["building"]);out;>;out skel qt;';
        console.log(data);
        //   console.log('[out:json];node(50.745,7.17,50.75,7.18)["highway"="bus_stop"];out;');
        getData(data);
    });
    function getData(data) {
        ...
        $.ajax({
            ...
            success: function success(resdata) {
                console.dir(resdata);
                resdata = (0, _osmtogeojson2.default)(resdata); // => geojson
                console.log(resdata);
...
},{"osmtogeojson":6}],2:[function(require,module,exports){
...
},{"wgs84":8}],3:[function(require,module,exports){
...
},{"geojson-area":2}],4:[function(require,module,exports){
module.exports = require('./polygon-features.json')

},{"./polygon-features.json":5}],5:[function(require,module,exports){
module.exports=[
    {
        "key": "building",
        "polygon": "all"
...
},{"./lodash.custom.js":7,"geojson-rewind":3,"osm-polygon-features":4}],7:[function(require,module,exports){
(function (global){
/**
 * @license
